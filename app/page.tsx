  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none" aria-hidden>
      <motion.div className="absolute" style={{ bottom: '-8%', left: '-8%', width: 460 }}
        ...
        <div className="absolute pointer-events-none" style={{ top: '-90%', left: '-10%', width: '120%', height: '180%',
      ...
      <motion.div className="absolute" style={{ top: '10%', right: '3%', width: 152 }}
        ...
        <div className="absolute pointer-events-none" style={{ top: '-80%', left: '-40%', width: '180%', height: '160%',
      ...
      <motion.div className="absolute" style={{ top: '5%', right: '22%', width: 94 }}
        ...
        <div className="absolute pointer-events-none" style={{ top: '-70%', left: '-50%', width: '200%', height: '140%',
      ...
      <motion.div className="absolute" style={{ top: '21%', left: '7%', width: 390 }}
        ...
        <div className="absolute pointer-events-none" style={{ top: '-120%', left: '-5%', width: '110%', height: '220%',
      ...
      <div className="absolute left-0 right-0" style={{ bottom: '30%', height: '1px',
...
// ─── Root page — adapts to auth state ────────────────────────────────────────
