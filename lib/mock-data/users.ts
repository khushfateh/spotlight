...
export const mockUsers: MockUser[] = [
  ...
  },
  {
    ...
    interests: ['pop', 'fashion', 'film', 'internet-culture'],
    spottedTickers: ['SABRINA', 'CHARLI', 'DOJACAT', 'NEWJEANS'],
    discoveryScore: 74,
    creatorsSpotted: 4,
  ...
  },
  {
    ...
    avatar: 'JK',
    initials: 'JK',
    bio: 'Gaming & streaming native. Spotted xQc when Twitch was still for speedrunners.',
    interests: ['gaming', 'streaming', 'hip-hop', 'internet-culture'],
    spottedTickers: ['XQC', 'KAICENAT', 'POKIMANE', 'ICESPICE', 'SPEED'],
    discoveryScore: 91,
    creatorsSpotted: 5,
